...
A bitcoin electrum (electrs) node has been installed and readied to receive connections from external services.
...
# Install Packages
sudo apt-get -y install ufw cargo clang psmisc
