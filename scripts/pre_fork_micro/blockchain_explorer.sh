...
cd ~; git clone https://github.com/satoshiware/btc-rpc-explorer
cd btc-rpc-explorer
...
BTCEXP_BITCOIND_HOST=$MICRO_ELECTRUM_LOCAL
BTCEXP_BITCOIND_PORT=19332
...
BTCEXP_ELECTRUM_SERVERS=tcp://$MICRO_ELECTRUM_LOCAL:51001
