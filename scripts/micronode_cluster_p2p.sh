...
This readme was generated by the "micronode_cluster_p2p.sh" install script.
The "micronode_cluster_p2p.sh" script installs a "p2p" micronode (within a cluster) which is used to manage connections with all other internal and external nodes.
