...
nbxplorer: http://127.0.0.1:24444
btcpayserver: http://127.0.0.1:23000

debug::
sudo ufw allow 23000
sudo ufw allow 24444

http://192.168.2.18:23000
http://192.168.2.18:24444



http://192.168.2.18:24444/v1/cryptos/btc/fees/3

Don't forget to open it up on the router :-)
...
##### Install btcpay ##### Issue is back. I wonder if we need to restart it or something????? and if it matters?????        Hey no issue!!!! did something change with a restart????????????? Investigate!! !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Still crashing too.... An issue was encountered verifying workloads. For more information, run "dotnet workload update". !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Fixed nbxplorer, but still get error in btcpayserver
...
### Configure Lightning Connection ###
